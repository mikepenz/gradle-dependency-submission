export const EXPECTED_ROOT_GRADLE_DEPENDENCY_OUTPUT = [
  [
    {
      type: 'maven',
      name: 'spring-core',
...
export const EXPECTED_GRADLE_DEPENDENCY_OUTPUT = [
  [
    {
      type: 'maven',
...
export const GRADLE_EXAMPLE_DEPENDENCY_OUTPUT = [
  [
    {
      type: 'maven',
      name: 'kotlin-stdlib-jdk8',
...
export const GRADLE_EXAMPLE_DEPENDENCY_WITH_SUB_PROJECTS_OUTPUT = {
